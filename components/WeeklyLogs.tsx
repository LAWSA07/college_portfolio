  ...
  return (
    <section
      ...
      className="py-20 min-h-screen 
                 bg-gradient-to-br from-[#1E0269] via-[#2E1065] to-[#5E005E] 
                 text-white"
    >
      {/* Header Section */}
      <div className="text-center mb-16">
        ...
        >
          ...
          <span
            className="ml-4 
                           bg-gradient-to-l from-purple-400 to-fuchsia-400 
                           bg-clip-text text-transparent"
          >
            LOGS
          </span>
        ...
        <p className="mt-4 text-purple-200">
          Explore weekly progress and achievements
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
        {weeklyLogs.map((log) => {
          ...
          return (
            <div
              key={log.id}
              className="group rounded-xl p-6 shadow-lg
                         bg-[#1B1A2A]/60 backdrop-blur-md 
                         hover:bg-[#1B1A2A]/80 transition-colors
                  ...
                  {log.links.map((link, index) => (
                    <a
                      ...
                      className="px-5 py-2.5 
                                 ...
                                 hover:opacity-90 
                                 transition-all duration-300 text-sm flex items-center
                                 shadow-md hover:shadow-xl active:scale-95 gap-2"
                    >
