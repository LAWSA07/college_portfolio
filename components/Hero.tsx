      ...
      <div className="flex justify-center relative my-20">
        ...
        >
          ...
          <TextGenerateEffect
            ...
            md:text-5xl lg:text-6xl xl:text-[100px]"
            words="Transforming Concepts into seemless Users Experiences"
          />
          <p
            className="text-center md:tracking-wider
          mb-4 text-sm md:text-lg lg:text-xl xl:text-2xl"
          >
            Namaste,मेरा नाम हिमांशु सिंह असवाल है।
          </p>
          <a href="#about">
            <MagicButton
              title="Show my work"
